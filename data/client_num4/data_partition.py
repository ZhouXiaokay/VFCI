...
class DataPartition:
    ...
    def getDragonNetTensor(self, csv_path, server_flag):
        if server_flag:
            ...
            id_train, id_test, x_train, x_test, yt_train, yt_test = train_test_split(np_ID, covariates_X, yt,
            ...
            return {"DragonNet_trainData": (tensor_id_train, tensor_x_train, tensor_yt_train),
                    "DragonNet_testData": (tensor_id_test, tensor_x_test, tensor_yt_test)}
        else:
