import torch
from comparative_exp.model.utils import dragonnet_loss_binarycross, seed_torch
from data.data_partition import DataPartition
from comparative_exp.model.DragonNet import DragonNet
import numpy as np
...
def train_dragonNet(train_x, concat_true, loss_func):
    ...
    for epo in range(1, 201):
        ...
        if epo % 10 == 0:
            ...
            print(t)
    torch.save(dragonnet.state_dict(), 'save/dragonnet/DragonNet_Central.pth')
